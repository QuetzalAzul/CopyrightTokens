...
_supportedInterfaces: HashMap[Bytes[4], bool]
...
def mint(account: address, id: uint256, amount: uint256, data: bytes32):
    ...
    assert self.copyrights_minteados + amount <= _copyright_a_vender, 'Insufficient copyright tokens for sell'
